  ...
  return (
    <form className="flex flex-col gap-6">
      ...
      <div className="grid gap-6">
        <Button
          variant="outline"
          className="w-full text-[#474d52] bg-gradient-to-b from-[#61CCC2] to-[#FFE08D] rounded-full"
      ...
      <div className=" text-xs text-[#F8D371] text-center">
        <p className="text-balance whitespace-nowrap">
          {t('terms_and_privacy.text')}{' '}
          <a className="hover:text-primary underline underline-offset-4 text-[#69C7BF]" href="#">
