  ...
  return (
    <section className="relative flex min-h-[100svh] w-full items-center justify-center overflow-x-clip bg-gradient-to-b from-[#61CCC1] to-[#FDDF8D] text-center text-[50px] font-[700] lg:min-h-screen">
      ...
      <div
        data-aos="fade-up"
        data-aos-delay="500"
        className="absolute bottom-[14vw] z-[9] w-full lg:bottom-[5vw]"
      >
        <TanahAtas />
      </div>
      <div
        data-aos="fade-up"
        data-aos-delay="500"
        className="absolute bottom-0 z-[8] aspect-[25/5] w-full bg-lightyellow lg:hidden"
      />

      <div data-aos="fade-up" className="absolute bottom-0 z-[12] w-full">
        <TanahBawah />
      </div>
    </section>
  );
